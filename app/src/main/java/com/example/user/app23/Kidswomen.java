 ...
 */
public class Kidswomen extends Fragment {
    ArrayList<Setget_men> setget_men;
    RecyclerView womenkids_rv;
    Context context;
    Adapt_men adapt_men;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_kidswomen, container, false);
        womenkids_rv = (RecyclerView) view.findViewById(R.id.womenkids_rv);
        sp = getActivity().getSharedPreferences(Constant.PER, MODE_PRIVATE);

        womenkids_rv.setLayoutManager(new GridLayoutManager(getActivity(), 2));
        womenkids_rv.setItemAnimator(new DefaultItemAnimator());
        setget_men = new ArrayList<>();
        manager = getFragmentManager();
        if (new ConnectionDetector(getActivity()).isConnectingToInternet()) {
            new kidswomendata().execute();
        } else {
            new ConnectionDetector(getActivity()).connectiondetect();
        }
        return view;
    }
    private class kidswomendata extends AsyncTask<String, String, String> {
        ProgressDialog pd;
        ...
        protected String doInBackground(String... params) {
            return new MakeServiceCall().MakeServiceCall(Constant.SAMANTA_IP + "getProductByPersonMaster.php?action=getProductByPersonMaster&person_master_id=4", MakeServiceCall.GET);
        }
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                womenkids_rv.setAdapter(adapt_men);
